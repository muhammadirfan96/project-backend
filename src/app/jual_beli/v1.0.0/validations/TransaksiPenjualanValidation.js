  ...
  param("id")
    ...
    .custom(async (value, { req }) => {
      try {
        ...
        const data = await TransaksiPenjualanModel.findOne(filter);
...
const findTransaksiPenjualanValidation = [
  query("limit")
    .optional()
    .isInt({ min: 1, max: 100 })
...
export { showTransaksiPenjualanValidation, findTransaksiPenjualanValidation };
